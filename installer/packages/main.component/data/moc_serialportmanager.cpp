...
void SerialPortManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dataReceived((*reinterpret_cast< std::add_pointer_t<uint8_t*>>(_a[1]))); break;
        case 1: _t->sendData((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SerialPortManager::*)(uint8_t * )>(_a, &SerialPortManager::dataReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void SerialPortManager::dataReceived(uint8_t * _t1)
{
